...
namespace Simple.SAMS.Competitions.Data
{
    ...
    partial void OnPositionChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Section", DbType="Int NOT NULL", IsPrimaryKey=true)]
		public int Section
		{
			get
			{
	...
	public partial class Match : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<int> _SlotType;
		
		private System.Nullable<int> _SlotPosition;
		
		private string _Player1Code;
		
		private string _Player2Code;
    ...
    partial void OnSlotTypeChanging(System.Nullable<int> value);
    partial void OnSlotTypeChanged();
    partial void OnSlotPositionChanging(System.Nullable<int> value);
    partial void OnSlotPositionChanged();
    partial void OnPlayer1CodeChanging(string value);
    partial void OnPlayer1CodeChanged();
    partial void OnPlayer2CodeChanging(string value);
    partial void OnPlayer2CodeChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_RoundRelativePosition", DbType="Int NOT NULL")]
		public int RoundRelativePosition
		{
			get
			{
				return this._RoundRelativePosition;
			}
			set
			{
				if ((this._RoundRelativePosition != value))
				{
					this.OnRoundRelativePositionChanging(value);
					this.SendPropertyChanging();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_SlotType", DbType="Int")]
		public System.Nullable<int> SlotType
		{
			get
			{
			...
			set
			{
				if ((this._SlotType != value))
				{
					...
					this.SendPropertyChanged("SlotType");
					this.OnSlotTypeChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_SlotPosition", DbType="Int")]
		public System.Nullable<int> SlotPosition
		{
			get
			{
			...
			set
			{
				if ((this._SlotPosition != value))
				{
					this.OnSlotPositionChanging(value);
					this.SendPropertyChanging();
					this._SlotPosition = value;
					this.SendPropertyChanged("SlotPosition");
					this.OnSlotPositionChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Player1Code", DbType="NVarChar(10)")]
		public string Player1Code
		{
			get
			{
				return this._Player1Code;
			}
			set
			{
				if ((this._Player1Code != value))
				{
					this.OnPlayer1CodeChanging(value);
					this.SendPropertyChanging();
					this._Player1Code = value;
					this.SendPropertyChanged("Player1Code");
					this.OnPlayer1CodeChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Player2Code", DbType="NVarChar(10)")]
		public string Player2Code
		{
			get
			{
				return this._Player2Code;
			}
			set
			{
				if ((this._Player2Code != value))
				{
					this.OnPlayer2CodeChanging(value);
					this.SendPropertyChanging();
					this._Player2Code = value;
					this.SendPropertyChanged("Player2Code");
					this.OnPlayer2CodeChanged();
				}
			}
		}
	...
	public partial class Player : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<int> _AccumulatedScore;
		
		private System.Nullable<int> _AverageScore;
    ...
    partial void OnAccumulatedScoreChanging(System.Nullable<int> value);
    partial void OnAccumulatedScoreChanged();
    partial void OnAverageScoreChanging(System.Nullable<int> value);
    partial void OnAverageScoreChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_AccumulatedScore", DbType="Int")]
		public System.Nullable<int> AccumulatedScore
		{
			get
			{
			...
			set
			{
				if ((this._AccumulatedScore != value))
				{
					this.OnAccumulatedScoreChanging(value);
					this.SendPropertyChanging();
					this._AccumulatedScore = value;
					this.SendPropertyChanged("AccumulatedScore");
					this.OnAccumulatedScoreChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_AverageScore", DbType="Int")]
		public System.Nullable<int> AverageScore
		{
			get
			{
